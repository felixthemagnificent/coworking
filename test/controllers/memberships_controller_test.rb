...
class MembershipsControllerTest < ActionController::TestCase
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post :create, membership: { description: @membership.description, name: @membership.name }
    end
  ...
  test "should update membership" do
    patch :update, id: @membership, membership: { description: @membership.description, name: @membership.name }
    assert_redirected_to membership_path(assigns(:membership))
  end
